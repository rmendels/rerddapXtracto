...
Note carefully that "Mean" is capitalized,  and that the number of neighbors is passed as a character string,  not as a number. Also the values of "xlen",  "ylen", and "zlen",  if given,  are ignored.  So to use the "interp" option in he first Marlin example,  the call would be:
...
swchl1 <- rxtracto(swchlInfo, parameter = 'chlorophyll', xcoord = xpos, ycoord = ypos, tcoord = tpos, zcoord = zpos,  interp = my_interp, progress_bar = TRUE)
